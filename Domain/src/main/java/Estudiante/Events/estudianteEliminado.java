...
public class estudianteEliminado extends DomainEvent {
    ...
    public estudianteEliminado(EstudianteId estudianteId, Correo correo , Fullname fullname , SuscripcionId suscripcionId
            , Identificacion identificacion){
        super("Sofka.Estudiante.estudianteEliminado");
        this.correo=correo;

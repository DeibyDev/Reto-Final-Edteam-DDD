...
public class estudianteEditado extends DomainEvent {
    ...
    public estudianteEditado(EstudianteId estudianteId, Correo correo , Fullname fullname , SuscripcionId suscripcionId
            , Identificacion identificacion){
        super("Sofka.Estudiante.estudianteEditado");
        this.correo=correo;

...
public class ActualizarEstudianteCommand extends Command {
    ...
    public ActualizarEstudianteCommand(EstudianteId estudianteId, Correo correo, Fullname fullname, SuscripcionId suscripcionId, Identificacion identificacion) {
        this.correo = correo;
